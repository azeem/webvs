...
CanvasTestWithFM("ChannelShift", 5, function(canvas, gl, fm, copier) {
    ...
    _.each(testOptions, function(opts, index) {
        ...
        imageFuzzyOk("ChannelShift " + index, gl, canvas, expectedImages[index]);
