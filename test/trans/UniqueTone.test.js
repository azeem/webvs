...
CanvasTestWithFM("UniqueTone", 6, function(canvas, gl, fm, copier) {
    ...
    _.each(testValues, function(opts, index) {
        ...
        imageFuzzyOk("UniqueTone "+index, gl, canvas, expectedImages[index]);
