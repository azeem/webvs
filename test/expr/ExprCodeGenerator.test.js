...
QUnit.test('ExprCodeGenerator GLSL Generation', function() {
...
QUnit.test("ExprCodeGenerator comments", function() {
    var gen = Webvs.compileExpr({
        test: [
    ...
    gen.codeInst.a = 1;
    gen.codeInst.test();
    QUnit.equal(gen.codeInst.c, 5, "comments are supported");
});

QUnit.test("ExprCodeGenerator register support", function() {
    ...
    js1.test();
    js2.test();
    QUnit.equal(js2.b, 11, "register variables with @ syntax works");
    QUnit.equal(js2.c, 12, "register variables with regXX syntax works");
});

QUnit.test("ExprCodeGenerator comparison function test", function() {
    ...
    js.c = 12.54;
    js.test();
    QUnit.equal(js.d, 12.54, "if and above works");
    QUnit.equal(js.e, 9.23, "if and below works");
});

QUnit.test("ExprCodeGenerator trailing space and empty code", function() {
    var js = (Webvs.compileExpr({
        test: "   a=a+1",
        test2: "    a=a+2;",
        test3: "    "
    ...
    js.test2();
    js.test3();
    QUnit.equal(js.a, 4, "code with trailing space should run");
});
