...
function parseColor(color) {
    if (isColor(color)) {
        ...
        if (match) {
            return _.chain(match).takeRight(3).map(function (channel) {
...
var Component = /** @class */ (function (_super) {
    ...
    function Component(main, parent, options) {
        ...
        if (!_this.id) {
            _this.id = _.uniqueId(_this.constructor.componentName + "_");
        }
        _this.enabled = _.isUndefined(options.enabled) ? true : options.enabled;
        _this.opts = _.omit(options, ["id", "enabled"]);
        var defaultOptions = _this.constructor.defaultOptions;
        if (defaultOptions) {
            _this.opts = _.defaults(_this.opts, defaultOptions);
        }
        _this.init();
        return _this;
    }
...
var geometries_1 = __webpack_require__(8);
/**
...
var ShaderProgram = /** @class */ (function () {
    ...
    ShaderProgram.prototype.getTextureId = function (name) {
        var id = _.indexOf(this.textureVars, name);
        if (id === -1) {
...
var CodeInstance_1 = __webpack_require__(7);
var ExprGrammar_pegjs_1 = __webpack_require__(23);
...
function processAst(codeAst, jsFuncs, glslFuncs, extraNonUniforms) {
    ...
    var processNode = function (ast, name) {
        if (ast instanceof Ast.Program) {
            ...
            if (glslFuncs.indexOf(name) >= 0 && glslPreComputeFuncs.indexOf(ast.funcName) >= 0) {
                ...
                var entry = [ast.funcName].concat(_.map(args, function (arg) { return arg.value; }));
    ...
    for (var name_3 in codeAst) {
        ...
        funcCall[name_3] = _.uniq(funcCall[name_3]);
        variable[name_3] = _.uniq(variable[name_3]);
        register[name_3] = _.uniq(register[name_3]);
    }
    var jsVars = _.chain(variable).pick(jsFuncs).values().flatten().uniq().value();
    var glslVars = _.chain(variable).pick(glslFuncs).values().flatten().uniq().value();
    var nonUniforms = _.chain(glslVars).difference(jsVars).union(extraNonUniforms).uniq().value();
    var uniforms = _.intersection(glslVars, jsVars);
    var glslUsedFuncs = _.chain(funcCall).pick(glslFuncs).values().flatten().uniq().value();
    var glslRegisters = _.chain(register).pick(glslFuncs).values().flatten().uniq().value();
    return {
...
function generateJs(codeAst, tables, jsFuncs) {
    ...
    var registerUsages = _.chain(tables.register).values().flatten().uniq().value();
                    ...
                    var generateSelect_1 = function (args, i) {
                        if (args.length === 1) {
                            ...
                            return [
                                "((" + selectExpr_1 + " === " + i + ")?",
                                "(" + generateNode(args[0]) + "):",
                                "(" + generateSelect_1(_.takeRight(args, args.length - 1), i + 1) + "))",
                            ].join("");
                        }
                    };
                    return generateSelect_1(_.takeRight(ast.args, ast.args.length - 1), 0);
                }
                case "sqr":
...
var Model = /** @class */ (function (_super) {
    ...
    Model.prototype.stopListening = function (emitter, event, callback) {
        ...
        var subs = _.filter(this.subscriptions, filter);
...
var CodeInstance = /** @class */ (function () {
    ...
    CodeInstance.copyValues = function (dest, src) {
        _.each(src, function (value, name) {
    ...
    CodeInstance.prototype.bindUniforms = function (program) {
        var _this = this;
        // bind all values
        _.each(this.uniforms, function (name) {
            program.setUniform(name, utils_1.WebGLVarType._1F, _this[name]);
        });
        // bind registers
        _.each(this.glslRegisters, function (name) {
        ...
        _.each(this.preCompute, function (entry, name) {
    ...
    CodeInstance.prototype.setup = function (main) {
        ...
        _.each(this.registerUsages, function (name) {
            if (!_.has(_this.registerBank, name)) {
...
var WebAudioAnalyser_1 = __webpack_require__(44);
var AnalyserAdapter_1 = __webpack_require__(12);
var ShaderProgram_1 = __webpack_require__(3);
var Webvs = {
...
exports.__esModule = true;
var _ = __webpack_require__(2);
var stats_js_1 = __webpack_require__(17);
var builtinResourcePack_1 = __webpack_require__(18);
var ComponentRegistry_1 = __webpack_require__(19);
var EffectList_1 = __webpack_require__(20);
var BufferSave_1 = __webpack_require__(24);
var GlobalVar_1 = __webpack_require__(25);
var Model_1 = __webpack_require__(6);
var ClearScreen_1 = __webpack_require__(26);
var MovingParticle_1 = __webpack_require__(27);
var Picture_1 = __webpack_require__(28);
var SuperScope_1 = __webpack_require__(29);
var Texer_1 = __webpack_require__(30);
var ResourceManager_1 = __webpack_require__(31);
var ChannelShift_1 = __webpack_require__(32);
var ColorClip_1 = __webpack_require__(33);
var ColorMap_1 = __webpack_require__(34);
var Convolution_1 = __webpack_require__(35);
var DynamicMovement_1 = __webpack_require__(36);
var FadeOut_1 = __webpack_require__(37);
var Invert_1 = __webpack_require__(38);
var Mirror_1 = __webpack_require__(39);
var Mosaic_1 = __webpack_require__(40);
var UniqueTone_1 = __webpack_require__(41);
var utils_1 = __webpack_require__(0);
var CopyProgram_1 = __webpack_require__(42);
var RenderingContext_1 = __webpack_require__(43);
var TextureSetManager_1 = __webpack_require__(10);
/**
...
var builtinResourcePack = {
    ...
    name: "Builtin",
    prefix: "https://unpkg.com/webvs@2.0.0/resources/"
};
...
var compileExpr_1 = __webpack_require__(4);
var TextureSetManager_1 = __webpack_require__(10);
/**
...
var Component_1 = __webpack_require__(1);
var utils_1 = __webpack_require__(0);
var ClearScreenProgram_1 = __webpack_require__(11);
...
var SuperScope = /** @class */ (function (_super) {
    ...
    SuperScope.prototype.updateColors = function () {
        this.colors = _.map(this.opts.colors, utils_1.parseColorNorm);
        this.curColorId = 0;
    };
...
var ColorMap = /** @class */ (function (_super) {
    ...
    ColorMap.prototype.updateMap = function () {
        ...
        this.colorMaps = _.map(this.opts.maps, function (map) { return _this._buildColorMap(map); });
        this.currentMap = 0;
    };
    ...
    ColorMap.prototype._buildColorMap = function (map) {
        var gl = this.main.getRctx().getGl();
        ...
        var cmi = 0;
        var pairs = _.zip(_.take(parsedMap, parsedMap.length - 1), _.takeRight(parsedMap, parsedMap.length - 1));
