 ...
 *  schema when set.
 */
formNode.prototype.computeInitialValues = function (values, ignoreDefaultValues, forceDefaults) {
  var self = this;
  var node = null;
  var nbChildren = 1;
  var i = 0;
  ...
  if (this.view && this.view.inputfield && this.schemaElement) {
    ...
    if (!ignoreDefaultValues && (!values || (values && forceDefaults && !valueSet))) {
  ...
  _.each(this.children, function (child) {
    child.computeInitialValues(values, ignoreDefaultValues, forceDefaults);
  });
...
formTree.prototype.computeInitialValues = function () {
  this.root.computeInitialValues(this.formDesc.value, false, this.formDesc.forceDefaults);
};
